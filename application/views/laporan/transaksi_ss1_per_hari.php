                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select id="pilihan_data" name="pilihan_data" class="form-control">
                                <option value="nonbunga">Tanpa Data Bunga</option>
                                <option value="bungasaja">Data Bunga Saja</option>
...
function tampilkan() {
    ...
    if (validasi) {
        ...
        $.ajax({
            url: situs + "laporan/transaksi_ss1_per_hari/tampilkan",
            data: data_form,
            type: "POST",
            beforeSend: function() {
                proses();
...
function cetak() {
    ...
    if (validasi) {
        ...
        window.open(situs + "laporan/transaksi_ss1_per_hari/cetak?data=" + data_form);
    }
}
</script>
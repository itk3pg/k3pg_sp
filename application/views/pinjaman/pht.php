<ul class="nav nav-tabs navtab-bg" id="myTab">
    <li class="active">
        <a href="#input" class="input">Pinjaman Hari Tua</a>
    </li>
    <li>
...
<div class="tab-content">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="gaji" name="gaji" class="form-control number_format" onchange="tombol_mode(1);proses_perhitungan_pht();" required="" value="0" data-rule-number="true" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon">Rp</div>
                                <input type="text" id="plafon" name="plafon" class="form-control number_format" onchange="tombol_mode(1);proses_perhitungan_pht();" required="" value="0" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="tgl_pinjam" name="tgl_pinjam" class="form-control datepicker" onchange="tombol_mode(1);proses_perhitungan_pht();" readonly="" required="" value="<?php echo date('d-m-Y'); ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon">Rp</div>
                                <input type="text" id="jml_pinjam" name="jml_pinjam" class="form-control number_format" onchange="tombol_mode(1);proses_perhitungan_pht();" required="" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Jangka Pinjaman</label>
                            <div class="input-group">
                                <input type="text" name="tempo_bln" id="tempo_bln" class="form-control" data-rule-number="true" required="" onchange="tombol_mode(1);proses_perhitungan_pht();">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label>Pembayaran Bunga Pinjaman</label>
                            <select class="form-control" id="jns_potong_bunga" name="jns_potong_bunga" onchange="tombol_mode(1);proses_perhitungan_pht();" required="">
                                <option value="">[-PILIH-]</option>
                                <option value="ANGSURAN">Angsuran Potong Gaji</option>
                                <option value="POTONG">Potong Jumlah yang diterima</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label>Pembayaran Biaya Admin</label>
                                    <select class="form-control" id="jns_potong_admin" name="jns_potong_admin" onchange="tombol_mode(1);proses_perhitungan_pht();" required="">
                                        <option value="">[-PILIH-]</option>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label>Jumlah Diterima Anggota</label>
                            <div class="input-group">
                                <div class="input-group-addon">Rp</div>
                                <input type="text" id="jml_diterima" name="jml_diterima" class="form-control number_format" readonly="" value="0" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div id="div_tombol_simpan">
                        <div class="col-md-4 text-right">
                            <a class="btn btn-default" onclick="reset_form()">
                                    <i class="fa fa-times"></i> Batal</a>
                            <a class="btn btn-primary" onclick="simpan()">
                    ...
                    <div id="div_tombol_proses">
                        <div class="col-md-4 text-right">
                            <a class="btn btn-success" onclick="proses_perhitungan_pht()">
    ...
    <div class="tab-pane" id="view">
        ...
        <div class="panel-body">
            <table class="table table-bordered table-condensed table-striped table-hover nowrap" id="tabel_pht" width="100%">
                <thead>
                    <tr>
                        <th>No.</th>
                        <th>Tgl Pinjam</th>
...
function reset_form() {
    url_simpan = situs + "pinjaman/add_simulasi_pht";
...
function proses_perhitungan_pht() {
    ...
    if (validasi) {
        data_form = $("#fm_input").serialize() + "&no_ang=" + $("#fm_input #no_ang").val();
...
function get_pinjaman_pht() {
    // $fm_dt = $("#fm_dt").serialize();
    url_tabel = situs + "pinjaman/get_simulasi_pinjaman_pht";
    tabel_id = "tabel_pht";
...
function edit_data() {
    ...
    if (row) {
        if (row.is_realisasi == "1") {
            ...
            url_simpan = situs + "pinjaman/edit_simulasi_pht/" + row.no_pinjam;

<ul class="nav nav-tabs navtab-bg" id="myTab">
    <li class="active">
        <a href="#input" class="input">Pinjaman KPR</a>
    </li>
    <li>
...
<div class="tab-content">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="gaji" name="gaji" class="form-control number_format" onchange="tombol_mode(1);proses_perhitungan_kpr();" required="" value="0" data-rule-number="true" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon">Rp</div>
                                <input type="text" id="plafon" name="plafon" class="form-control number_format" onchange="tombol_mode(1);proses_perhitungan_kpr();" required="" value="0" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="tgl_pinjam" name="tgl_pinjam" class="form-control datepicker" onchange="tombol_mode(1);proses_perhitungan_kpr();" readonly="" required="" value="<?php echo date('d-m-Y'); ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon">Rp</div>
                                <input type="text" id="jml_pinjam" name="jml_pinjam" class="form-control number_format" onchange="tombol_mode(1);proses_perhitungan_kpr();" required="" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Jangka Pinjaman</label>
                            <div class="input-group">
                                <select id="tempo_bln" name="tempo_bln" class="form-control" onchange="tombol_mode(1);proses_perhitungan_kpr();" required="">
                                    <?php echo $tempo_bln; ?>
                                </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="persen_angsuran" id="persen_angsuran" class="form-control" onchange="tombol_mode(1);proses_perhitungan_kpr();" required="">
                        ...
                        <div class="form-group">
                            <div class="row" style="margin: 0px">
                                <div class="col-md-6" style="padding: 0px">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="min_angsuran" id="min_angsuran" class="form-control" onchange="tombol_mode(1);proses_perhitungan_kpr();" required="">
                                        <div class="input-group-addon">%</div>
                                    </div>
                                </div>
                                <div class="col-md-6" style="padding: 0 0 0 5px">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="max_angsuran" id="max_angsuran" class="form-control" onchange="tombol_mode(1);proses_perhitungan_kpr();" required="">
                                        <div class="input-group-addon">%</div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div id="div_tombol_proses">
                        <div class="col-md-4 text-right">
                            <a class="btn btn-success" onclick="proses_perhitungan_kpr()">
    ...
    <div class="tab-pane" id="view">
        ...
        <div class="panel-body">
            <table class="table table-bordered table-condensed table-striped table-hover nowrap" id="tabel_kpr" width="100%">
                <thead>
                    <tr>
                        <th>No.</th>
                        <th>Tgl Pinjam</th>
...
function reset_form() {
    url_simpan = situs + "pinjaman/add_simulasi_kpr";
...
function get_pinjaman_kpr() {
    url_tabel = situs + "pinjaman/get_simulasi_pinjaman_kpr";
    tabel_id = "tabel_kpr";
...
function edit_data() {
    ...
    if (row) {
        if (row.is_realisasi == "1") {
            ...
            url_simpan = situs + "pinjaman/edit_simulasi_kpr/" + row.no_pinjam;

                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="row" style="margin: 0px;">
                                <select id="kd_jns_transaksi" name="kd_jns_transaksi" class="form-control" required="" onchange="dttransfer()"></select>
                    ...
                    <div class="col-md-4">
						...
						<div class="form-group" id="transfer1" style="display:none">
...
function dttransfer(){
	 var kd_jns_transaksi = $("#kd_jns_transaksi").val();
	if(kd_jns_transaksi == "01" || kd_jns_transaksi == "02"){
		$('#transfer1').show();
		$('#transfer2').show();
	}
	else{

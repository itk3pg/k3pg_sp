...
class Transaksi_ss2_diperpanjang extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['judul_menu'] = "Laporan Transaksi SS2 Diperpanjang";
        $data['bulan']      = $bulan;

        $this->template->view("laporan/transaksi_ss2_diperpanjang", $data);
    ...
    public function tampilkan()
    {
        ...
        if ($data_req) {
            ...
            $data_ss2 = $this->db->where("(tgl_simpan between '" . $tgl_awal . "' and '" . $tgl_akhir . "')")
                ->where("is_dipercepat", "0")
                ->where("ket", "DIPERPANJANG")
    ...
    public function cetak()
    {
        ...
        $judul_file   = "cetak_ss2_diperpanjang_" . date("Y-m-d_H-i-s") . ".pdf";
        ...
        $pdf->Cell(0, 0, "Laporan Simpanan Sukarela 2 Diperpanjang", 0, 0, "C");
        $pdf->SetFontSize('8');

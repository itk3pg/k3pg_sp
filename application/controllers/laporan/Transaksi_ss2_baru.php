...
class Transaksi_ss2_baru extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['judul_menu'] = "Laporan Transaksi SS2 Baru";
        $data['bulan']      = $bulan;

        $this->template->view("laporan/transaksi_ss2_baru", $data);
    }
    ...
    public function cetak()
    {
        ...
        $pdf->Cell(0, 0, "Laporan Simpanan Sukarela 2 Baru", 0, 0, "C");
        $pdf->SetFontSize('8');
